describe('FileClassStateManager additional event handlers', () => {
  let mockApp: any;
  ...
  test('handleModifyFileEvent calls callback if fileClass changes', () => {
    ...
    expect(mockCallback).toHaveBeenCalledWith(file, expect.anything(), 'oldClass', 'newClass');
  });
...
// File: src/managers/FileClassStateManager.test.ts
