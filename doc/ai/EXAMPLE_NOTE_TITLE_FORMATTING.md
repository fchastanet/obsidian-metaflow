...
it will produce the following title: `1925 - The Great Gatsby - F. Scott Fitzgerald` if the date is missing, it will
produce the following title: `The Great Gatsby - F. Scott Fitzgerald`
...
- `"MetaFlow: Template '{{invalid}}' could not be processed due to missing metadata"` - When template has missing
  placeholders
